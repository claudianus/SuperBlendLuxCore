...
TESSEL_ITEMS = [
    (
        "ribbon",
        "Triangle Ribbon",
        "Render hair as ribbons of triangles facing the camera",
    ),
    (
        "ribbonadaptive",
        "Adaptive Triangle Ribbon",
        "Render hair as ribbons of triangles facing the camera, "
    ...
    (
        "solid",
        "Solid",
        "Render hairs as solid mesh cylinders (memory intensive!)",
    ),
    (
        "solidadaptive",
        "Adaptive Solid",
        "Render hairs as solid mesh cylinders, "
...
COLOREXPORT_ITEMS = [
    (
        "vertex_color",
        "From Emitter Vertex Colors",
        "Copy emitter vertex colors to hair vertex colors. "
        "This option increases the memory usage of the hair",
    ),
    (
        "uv_texture_map",
        "From UV Texture Map",
        "Copy colors from an image texture to hair vertex colors. "
        "This option increases the memory usage of the hair",
    ),
    (
        "none",
        "White",
        "Do not set the hair vertex colors (they will be white). This option does not "
...
INSTANCING_TYPES = [
    (
        "enabled",
        "Save Memory",
        "Instance the hair mesh to save memory "
        "(reduces rendering performance of the hair)",
        0,
    ),
    (
        "disabled",
        "Improve Performance",
        "Do not instance the mesh, this increasees the rendering "
        "performance of the hair, but costs more memory",
        1,
    ),
]
...
class SuperLuxCoreHair(PropertyGroup):
    ...
    hair_size: FloatProperty(
        ...
        subtype="DISTANCE",
        unit="LENGTH",
        description="Diameter of the individual hair strands",
    )
    ...
    use_active_vertex_color_layer: BoolProperty(
        name="Use Active Vertex Color Layer", default=True
    )
    ...
    copy_uv_coords: BoolProperty(
        name="Copy UV Coordinates",
        default=True,
    ...
    instancing: EnumProperty(
        name="Optimization",
        default="disabled",
        items=INSTANCING_TYPES,
